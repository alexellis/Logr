...
function renderMasterPage(content,groupedContent) {
    var html=
        "<html>\n"+
        "<head>\n"+
...
function simpleRenderEvents(req, res, list) {
    var content = renderItemsBody(list);

    var grouped = groupById(list);
    var groupedContent=renderGroup(grouped);

    res.write(renderMasterPage(content,groupedContent));
    res.end();
};
...
module.exports.renderMasterPage = renderMasterPage;
module.exports.Item=Item;
module.exports.groupById=groupById;
module.exports.renderItemsBody=renderItemsBody;